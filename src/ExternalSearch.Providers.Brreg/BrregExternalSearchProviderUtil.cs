...
public static class BrregExternalSearchProviderUtil
{
    ...
    internal static Func<string, bool> NamePostFixFilter(HashSet<string> countryCode, Func<string, bool> countryFilter,
        HashSet<string> contains, HashSet<string> name, HashSet<string> postFixes)
    {
