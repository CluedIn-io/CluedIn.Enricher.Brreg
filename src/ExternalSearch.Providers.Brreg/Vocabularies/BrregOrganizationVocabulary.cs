...
public class BrregOrganizationVocabulary : SimpleVocabulary
{
    public BrregOrganizationVocabulary()
    {
        ...
        AddGroup("Metadata", group =>
        {
            ...
            OrganizationTypeFull = group.Add(new VocabularyKey("organizationTypeFull", VocabularyKeyDataType.Json,
            ...
            RegisteredImGoodsRegister =
                group.Add(new VocabularyKey("registeredImGoodsRegister", VocabularyKeyDataType.Boolean));
            RegisteredBusinessRegister =
                group.Add(new VocabularyKey("registeredBusinessRegister", VocabularyKeyDataType.Boolean));
            RegisteredFoundingRegister =
                group.Add(new VocabularyKey("registeredFoundingRegister", VocabularyKeyDataType.Boolean));
            ...
            UnderLiquidationOrDissolution =
                group.Add(new VocabularyKey("underLiquidationOrDissolution", VocabularyKeyDataType.Boolean));
            LatestFiledAnnualAccounts =
                group.Add(new VocabularyKey("latestFiledAnnualAccounts", VocabularyKeyDataType.Boolean));
        ...
        AddMapping(BrregNumber, Core.Data.Vocabularies.Vocabularies.CluedInOrganization.CodesBrreg);
        AddMapping(NumberEmployees, Core.Data.Vocabularies.Vocabularies.CluedInOrganization.EmployeeCount);
        AddMapping(FoundedDate, Core.Data.Vocabularies.Vocabularies.CluedInOrganization.FoundingDate);
        AddMapping(Website, Core.Data.Vocabularies.Vocabularies.CluedInOrganization.Website);

        AddMapping(BusinessAddress.Address, Core.Data.Vocabularies.Vocabularies.CluedInOrganization.Address);
        AddMapping(BusinessAddress.CountryCode,
            Core.Data.Vocabularies.Vocabularies.CluedInOrganization.AddressCountryCode);
        AddMapping(BusinessAddress.PostalCode, Core.Data.Vocabularies.Vocabularies.CluedInOrganization.AddressZipCode);
        AddMapping(BusinessAddress.PostalArea,
            Core.Data.Vocabularies.Vocabularies.CluedInOrganization.AddressPostalArea);

        AddMapping(IndustryDescription, Core.Data.Vocabularies.Vocabularies.CluedInOrganization.Industry);
    }
